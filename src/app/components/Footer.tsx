...
export default function Footer() {
  return (
    <footer className="text-[#8A8FB9] bg-[#EEEFFB] body-font ">
      {/* Footer Top Section */}
      <div className="container px-5 py-12 mx-auto flex flex-wrap flex-col lg:flex-row">
        ...
        <div className="flex-shrink-0 text-center lg:text-left lg:w-1/3 mb-8 lg:mb-0">
          <span className="text-[38px] font-bold text-black ">
            Hekto
          </span>
          <div className="mt-4 flex items-center font-[lato] justify-center lg:justify-start">
            <input
              type="text"
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-12 lg:gap-16 w-full lg:w-2/3">
          ...
          <div>
            ...
            <ul className="mt-4 font-[lato] space-y-2">
      ...
      <div className="bg-[#E7E4F8] py-4">
        <div className="container mx-auto px-5 flex flex-wrap justify-evenly items-center">
          <p className="text-gray-500 text-sm font-[lato] text-center lg:text-left w-full lg:w-auto mb-4 lg:mb-0">
